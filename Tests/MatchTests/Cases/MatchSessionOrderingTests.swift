...
struct MatchSessionOrderingTests {
    ...
    func answersReachTheWireInRequestOrder() async throws {
        ...
        host.startMatch(seed: 11, startingHandSize: 0, countdownSeconds: 0)
    ...
    func exhaustionAheadOfAGrantIsNotTerminal() async throws {
        ...
        wire.deliver(.start(version: WireFormat.current, seed: 1, startingHandSize: 0, countdownSeconds: 0))
    ...
    func aDeviceNeverReceivesItsOwnSends() async throws {
        ...
        host.startMatch(seed: 5, startingHandSize: 0, countdownSeconds: 0)
        #expect(host.state.status == .playing)
        ...
        #expect(landed.first == .start(version: WireFormat.current, seed: 5, startingHandSize: 0, countdownSeconds: 0))
