...
struct MatchSessionTerminalAuditTests {
    ...
    static func playingHost(
        ...
        host.startMatch(seed: 3, startingHandSize: 0, countdownSeconds: 0)
    ...
    func eachStreamHasExactlyOneConsumer() async throws {
        ...
        wire.deliver(
            .start(version: WireFormat.current, seed: 1, startingHandSize: 0, countdownSeconds: 0)
        )
    ...
    func nothingReopensAFinishedMatch() async throws {
        ...
        wire.deliver(.start(version: WireFormat.current, seed: 42, startingHandSize: 0, countdownSeconds: 7))
