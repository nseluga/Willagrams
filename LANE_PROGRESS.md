...
- **Next:** round-3 item 8 (invite a friend from the open seat), then items 9-13 in `LANE.md` order. Items 1-7 are done
- **Per-item floors now (counts are floors):** rules 53 · Board 271 · Match 128 · Style 44 · Shell 271 (run `--no-parallel`) · Settings 37 · Bot 68 · Online 147 (1 known pre-existing issue at `WholeMatchScript.swift:98`) · Audio 19 · Account 21 · Friends 54
