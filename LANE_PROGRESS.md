...
- **Next:** round-3 item 6 (a saved name reaches the whole app), then items 7-13 in `LANE.md` order. Items 1-5 are done
- **Per-item floors now (counts are floors):** rules 53 · Board 271 · Match 128 · Style 44 · Shell 266 (run `--no-parallel`) · Settings 37 · Bot 68 · Online 147 (1 known pre-existing issue at `WholeMatchScript.swift:98`) · Audio 19 · Account 16 · Friends 54
